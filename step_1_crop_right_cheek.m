...
%             threshold = min_x + center;
            ...
            [p1_x p1_y] = find(fitted_shape(:, 1) == fitted_shape_x_sorted(end));   
...
%              end
            ...
            move_down = 120;
            rcheeck_rect = [fitted_shape_x_sorted(end)-rcheeck_w, fitted_shape(p1_x, 2)+move_down-rcheeck_h, rcheeck_w, rcheeck_h];
